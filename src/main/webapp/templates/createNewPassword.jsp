        ...
        <div class="card-body">
          ...
          <div class="form-row">
           ...
           <div class="form-row">
                                  ...
                                  <input type="password" name="password" id="password" class="form-control" onchange="validatePassword()">
                                  <p id="password-error"  style="color: red; display: none;">Mật khẩu phải có từ 8 đến 20 ký tự, bao gồm chữ hoa, chữ thường, số và ký tự đặc biệt.</p>

           				</div>
           				    <div class="form-row">
                                   						<label>Nhập lại mật khẩu </label>
                                   					    <input id="Checkpassword"  name="Checkpassword" class="form-control" type="password" onChange="validateCheckPassword()">
